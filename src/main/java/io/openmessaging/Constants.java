...
//    static final int STAGE_MSG_BYTE_LENGTH = 42;
    ...
    static final int A_INDEX_META_FACTOR = 64;
    ...
    static final int READ_BODY_BUFFER_SIZE = BODY_BYTE_LENGTH * 1024 * 16;

    static final int READ_A1_BUFFER_SIZE = KEY_A_BYTE_LENGTH * 1024 * 16;
